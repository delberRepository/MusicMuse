 ...
 <nav>
    ...
    <div class="contenidoVentana">
     <div class="rotulo"> 
        ...
        <p>Registrarse para una cuenta de MuseMusic</p>
     </div>       
	  ...
	  <aside>
		...
		<section> 
                ...
                <div class="container">
                    ...
                    <p style="margin-left:60px;"><?php  if ($_SERVER["REQUEST_METHOD"] == "POST") {echo strtoupper('Cambio realizado!');}
                     else if (isset($_GET['status'])){echo strtoupper(($_GET['status'])).'!</p><img src="Laurel_and_Hardy.png"></img><h1 style="margin-bottom:200px; margin-left:30px"></h1>';}?>
                      <?php if (!isset($_GET['status'])): ?>
                        <div class="form-group">
                            <label for="usuario">Nombre de Usuario</label>
                            <input type="text" id="usuario" name="usuario" style="width: 240px" placeholder="Nombre"
                       ...
                       <!-- <div class="form-group">
                        ...
                        <?php endif; ?>
                            ...
                            <a href="eliminarPerfil.php"> <p class="cancelar">Eliminar Perfil</p></a>
                        </div> 
                        <?php endif; ?>
