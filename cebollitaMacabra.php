    ...
    <ul >
        <?php if (isset($_SESSION['usuario'])): ?>
            <li class="nav-item">
				...
				<li ><a href="miEspacio.php">Mis discos</a></li>
             ...
             <div class="container">
                 <div class="header">
                    ...
                    <div class="album-details">
                        <p >Álbum</p>
                        <h1 style="font-size: 50px;"><?php echo $titulo;?></h1>           <!--aqui tengo que sumar todos los minutos y segundos de las canciones y ponerlos-->
                        <p><a href="miEspacio.php"><strong><?php echo $NOMBRE;?></strong></a> • <?php echo substr($fechaLanzamiento, 0, -6);?> • <?php echo $numCanciones ?> canciones, 36 min 21 s</p>
                    </div>
                    </div>
                </div>    
