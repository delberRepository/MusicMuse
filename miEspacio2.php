...
error_reporting(E_ALL);
      ...
      //aqui de alguna froma a traves de alguna variable de sesion tengo identificar al artista
             ...
             <div class="container">
                 <div class="header">
                  ...
                  $stmt->close();
                            ...
                            echo '<p><strong>' . htmlspecialchars($NOMBRE) . '</strong> • ' . substr($fechaLanzamiento, 0, -6) . ' • ' . count($cancionesNombre) . ' canciones, 36 min 21 s</p>';
                            echo '</div>';
                            echo '</div>';
                            ...
                            echo '</div><br><br><br>'; // Cierre del contenedor de canciones
